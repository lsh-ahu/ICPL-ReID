...
def make_dataloader(cfg):
    ...
    train_set = ImageDataset(dataset.train, train_transforms, cfg.DATASETS.NAMES, use_gray=cfg.MODEL.USE_GRAY)
    train_set_normal = ImageDataset(dataset.train, val_transforms, cfg.DATASETS.NAMES, use_gray=cfg.MODEL.USE_GRAY)
    ...
    val_set = ImageDataset(dataset.query + dataset.gallery, val_transforms, cfg.DATASETS.NAMES, use_gray=cfg.MODEL.USE_GRAY)

    cam_set = ImageDataset(dataset.query + dataset.gallery, cam_transforms, cfg.DATASETS.NAMES, use_gray=cfg.MODEL.USE_GRAY)
    ...
    return train_loader_stage2, train_loader_stage1, val_loader, cam_loader, len(dataset.query), num_classes, cam_num, scene_num
